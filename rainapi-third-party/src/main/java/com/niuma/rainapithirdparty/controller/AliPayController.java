package com.niuma.rainapithirdparty.controller;
...
import com.niuma.rainapithirdparty.config.AliPayConfig;
import com.niuma.rainapithirdparty.model.dto.AlipayRequest;
import com.niuma.rainapithirdparty.model.entity.AlipayInfo;
import com.niuma.rainapithirdparty.service.AlipayInfoService;
import com.niuma.rainapithirdparty.utils.OrderPaySuccessMqUtils;
...
public class AliPayController {
    ...
    //异步回调和同步回调：异步回调是用在支付宝那边服务完成后，返回给商户的服务器，告诉商户的支付状态和订单信息；
                    //：同步回调是：用于支付宝那边的服务完成后，重定向到商户网站的页面
