package com.niuma.rainapi.utils;

import com.niuma.rainapicommon.constant.RabbitMqConstant;
...
public class SmsRabbitMqUtils implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnsCallback {
    ...
    // todo 改成value类型为Object类型，之前是String类型
    @Resource
    ...
    public void sendSmsAsync(SmsDTO smsDTO) {
        ...
        redisTemplate.opsForValue().set(RedisConstant.SMS_ORDER_NUM_PREFIX+smsDTO.getPhoneNum(),smsDTO);
        try {
